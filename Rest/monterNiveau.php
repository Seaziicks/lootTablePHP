...
switch ($http_method) {
    ...
    case "POST":
        if (!UserManager::hasRightToAccess(AccessRights::SAME_USER)) {
            ...
            /**
             * Permet de gerer la montee de niveau d'un personnage.
             * Quand un personnage gagne un niveau et attribut ses points de caracteristique,s c'est cette page qui est appellee
             */
            if (isset($_GET['idPersonnage']) && isset($_GET['Niveau'])) {
                try {
                    ...
                    /**
                     * Verifie que le personnage peut bien monter d'un niveau.
                     */
                    if ($personnage->_niveauEnAttente > 0) {
                        ...
                        /**
                         * Si le niveau envoye par le personnage est bien celui qui doit être assigne au personnage.
                         */
                        if ($niveau->_niveau === $personnage->_niveau + 1) {
                            ...
                            /**
                             * Permet de recuperer ce que le GameMaster a prevu de faire pour ce niveau.
                             */
                            ...
                            /**
                             * Verifie que le personnage a bien le droit de monter des statistiques pour ce niveau.
                             * Verifie egalement que le personnage se rajoute le nombre de statistique autorisee, pas moins pas plus.
                             * Verifie enfin que les de de mana et de vitalite sont coherents.
                             */
                            if ($progressionPersonnageNiveauFetched['statistiques']
                                ...
                                /**
                                 * Si le personnage essaye de se rajouter des statistiques alors que le GameMaster ne l'a pas prevu pour ce niveau,
                                 * ou que le de de vitalite ou de mana n'est pas coherent.
                                 */
                                http_response_code(406);
